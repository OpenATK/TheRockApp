...
export const initialize = sequence('app.initialize', [
  ({}) => ({
    ...
    options: {
      redirect: "https://openatk.com/TheRockApp/oauth2/redirect.html",//"https://localhost:8000/oauth2/redirect.html",//"https://openatk.github.io/TheRockApp/oauth2/redirect.html",
